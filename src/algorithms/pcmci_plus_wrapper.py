"""PCMCI+ (Tigramite) wrapper for contemporaneous and lagged links."""
...
class PCMCIPlusWrapper(CausalDiscoveryModel):
    """PCMCI+ extends PCMCI with orientation among contemporaneous parents."""
    ...
    def fit(self, data: np.ndarray) -> None:
        ...
        # Tigramite PCMCI+ uses ``pc_alpha`` for PC/MCI phases (no separate ``alpha_level``).
        pc_alpha = min(self.pc_alpha, self.alpha_level)
